#Code pour ouvrir la base de données PMI#
...
PMI_euro <- read_excel("C:/Users/paulf/Downloads/Test Git/Data PMI_memoire.xlsx", 
             sheet = 1,
             col_names = c("Date","Composite", "Synthétique industrie",
                           "Production passée", "Emploi_industrie", 
                           "Nouvelles commandes", "Stocks", 
                           "Délais de livraison", "Commandes export", 
                           "Prix output industrie", "Prix input industrie", 
                           "Synthétique services = activités", 
                           "Nouvelles affaires", "Emploi_services", 
                           "Backlogs of work","Activité future", 
